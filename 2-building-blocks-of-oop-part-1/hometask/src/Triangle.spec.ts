...
describe("Triangle", () => {
  ...
  it("should return required string", () => {
    expect(new Triangle(new Point(0, 0), new Point(7, 0), new Point(3, 8)).toString()).toBe(
      "Triangle[v1=(0, 0),v2=(7, 0),v3=(3, 8)]"
    );
  });
  ...
  it("should tell if the triangle is equilateral", () => {
    ...
    expect(new Triangle(new Point(0, 0), new Point(1, Math.sqrt(3)), new Point(2, 0)).getType()).toBe(
